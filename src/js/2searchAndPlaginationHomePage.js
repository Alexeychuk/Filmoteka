...
function fetchFilms() {
  fetch(
    `https://api.themoviedb.org/3/search/movie?api_key=9e008f5d338cd1f22f432e50e537417d&language=en-US&query=${inputValue}&page=${pageNumber}&include_adult=false`,
  )
...
function fillScrollBar() {
  ...
  if (!document.documentElement.scrollTop)
    document.querySelector('.progress-container').classList.add('disable');
  const windowScroll =
